...
- (void)viewDidLoad {
    ...
    hint = [NSArray arrayWithObjects:@"感谢你给我留言",
            ...
            nil];
    self.title=@"给我留言吧";
    NSString *text = @"如果你对我有什么话想说，或者不满，或者意见，或者建议，或者你认为我该怎么怎么样，等，请写下你的话，发给我，当然如果你希望我回复你，请留下联系方式，不然，这只是一个单项通信的功能啦。骂我的话尽量写的长一点，不然没诚意，想打我的人，请排好队，当然，即使排好队，也打不到我。给予我支持的人，都是好人，给予我鼓励的人，我心感激。我是一个爱好玩游戏的人，看到精致的游戏就忍不住做了攻略收藏在套装里，我的梦想是做一百个攻略放到套装里，所以你有喜欢的游戏可以推荐给我，或许我也喜欢呢。";
    ...
    btn.backgroundColor=[Common colorWithHexString:@"262626"];
...
-(void)sendMsg{
    ...
    testMsg.subject = [NSString stringWithFormat:@"IOS 300 hero version:%@,buildno:%@",appVersion,appBuild];
